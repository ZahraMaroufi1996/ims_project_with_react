      ...
      >
        <g id="Avatars-06" transform="translate(1603.97 371.971)">
          <g id="Layer_1" data-name="Layer 1">
            ...
            <g
              id="Group_2056"
              data-name="Group 2056"
              clip-path="url(#clip-path-2)"
            >
              <path
                id="Path_918"
                data-name="Path 918"
                d="M66.462,36.462V78.457H29.442V71.42a5.354,5.354,0,0,0,.849-1.561,22.106,22.106,0,0,0,1.092-9.31h0a71.241,71.241,0,0,1-1.941-8.509V36.462Z"
                fill="#221918"
              />
              <path
                id="Path_919"
                data-name="Path 919"
                d="M37.409,27.355v51.1H29.442V71.42a5.354,5.354,0,0,0,.849-1.561,22.106,22.106,0,0,0,1.092-9.31h0a71.241,71.241,0,0,1-1.941-8.509V28.4q.146-.534.315-1.043Z"
                fill="#693d34"
              />
              <path
                id="Path_920"
                data-name="Path 920"
                d="M55.567,59.1H43.92s.291,8.9-1.132,11.5H56.845C55.413,68.023,55.567,59.1,55.567,59.1Z"
                fill="#f4b78e"
              />
              <path
                id="Path_921"
                data-name="Path 921"
                d="M43.855,64.586c2.168,1.019,4.352,2,6.843,1.763a14.106,14.106,0,0,0,5.031-1.5c-.21-2.928-.17-5.743-.17-5.743H43.92S44.009,61.755,43.855,64.586Z"
                fill="#dfa57e"
              />
              <path
                id="Path_922"
                data-name="Path 922"
                d="M71.4,75.667,55.187,69.333H44.429L28.212,75.667S22.55,77.7,23.2,87.581H76.419C77.2,77.09,71.4,75.667,71.4,75.667Z"
                fill="#f4b78e"
              />
              <path
                id="Path_923"
                data-name="Path 923"
                d="M64.448,42.157c-.477,2.96.356,5.589,1.852,5.872s3.106-1.885,3.583-4.853-.356-5.589-1.86-5.872S64.925,39.188,64.448,42.157Z"
                fill="#f4b78e"
              />
              <path
                id="Path_924"
                data-name="Path 924"
                d="M66.252,41.356a1.67,1.67,0,0,1,.081-.437,5.435,5.435,0,0,1,.364-1.068c.186-.4.493-.849.874-.874a.809.809,0,0,1,.291.04,1.511,1.511,0,0,1,.146.073,1.149,1.149,0,0,1,.105.089,1.513,1.513,0,0,1,.364.647,3.785,3.785,0,0,1,.178.809,4.125,4.125,0,0,1,0,.809c-.049.3-.057.6-.113.857l-.146.744c-.065.235-.105.445-.146.639s-.1.348-.137.485c-.081.267-.113.429-.113.429s.081-.138.2-.38.146-.275.218-.453.162-.388.251-.615a7.23,7.23,0,0,0,.235-.809c.081-.315.121-.558.178-.857a3.98,3.98,0,0,0,0-1.011,4.522,4.522,0,0,0-.194-1,2.071,2.071,0,0,0-.526-.865,1.141,1.141,0,0,0-.21-.154,1.44,1.44,0,0,0-.21-.081,1.149,1.149,0,0,0-.453,0,1.181,1.181,0,0,0-.736.526,2.718,2.718,0,0,0-.356.744,4.724,4.724,0,0,0-.2,1.189,2.936,2.936,0,0,0,.057.526Z"
                fill="#f2a57f"
              />
              <path
                id="Path_925"
                data-name="Path 925"
                d="M66.252,41.356s-.137-.315.849-.388c0,0,1.108.2.453,1.674a4.773,4.773,0,0,0-.332.995c-.1.493.081,1.165-.186,1.618-.34.566-1.213.243-1.262-.4a3.713,3.713,0,0,1,.7-1.7,1.326,1.326,0,0,0-.226-1.8Z"
                fill="#f2a57f"
              />
              <path
                id="Path_926"
                data-name="Path 926"
                d="M65.775,44.769a.5.5,0,0,0-.073.081.955.955,0,0,0-.146.275.874.874,0,0,0-.04.17.76.76,0,0,0,0,.243c0,.081,0,.178,0,.267a1.982,1.982,0,0,0,.081.243,1.157,1.157,0,0,0,.113.226,1.837,1.837,0,0,0,.146.17.631.631,0,0,0,.3.218.9.9,0,0,0,.34.081,2.257,2.257,0,0,0-.17-.315.97.97,0,0,0-.081-.138,1.733,1.733,0,0,0-.073-.162,1.093,1.093,0,0,0-.081-.154.809.809,0,0,1-.065-.162,1.755,1.755,0,0,1-.121-.324,1.344,1.344,0,0,1-.04-.162c0-.057,0-.113,0-.162A1.953,1.953,0,0,1,65.775,44.769Z"
                fill="#f2a57f"
              />
              <path
                id="Path_927"
                data-name="Path 927"
                d="M35.864,42.157c.477,2.96-.356,5.589-1.852,5.872s-3.106-1.885-3.583-4.853.356-5.589,1.86-5.872S35.387,39.188,35.864,42.157Z"
                fill="#f4b78e"
              />
              <path
                id="Path_928"
                data-name="Path 928"
                d="M34.06,41.356a1.67,1.67,0,0,0-.081-.437,5.363,5.363,0,0,0-.364-1.068c-.186-.4-.493-.849-.874-.874a.809.809,0,0,0-.291.04,1.512,1.512,0,0,0-.146.073,1.012,1.012,0,0,0-.105.089,1.521,1.521,0,0,0-.364.647,3.826,3.826,0,0,0-.178.809,4.117,4.117,0,0,0,0,.809c.049.3.057.6.113.857l.146.744c.065.235.105.445.154.639s.1.348.138.485c.081.267.113.429.113.429s-.081-.138-.2-.38-.146-.275-.218-.453-.162-.388-.251-.615a7.229,7.229,0,0,1-.235-.809q-.11-.424-.178-.857a3.963,3.963,0,0,1,0-1.011,4.5,4.5,0,0,1,.194-1,2.071,2.071,0,0,1,.526-.865,1.116,1.116,0,0,1,.21-.154,1.431,1.431,0,0,1,.2-.081,1.157,1.157,0,0,1,.453,0,1.181,1.181,0,0,1,.736.526,2.718,2.718,0,0,1,.356.744,4.667,4.667,0,0,1,.2,1.189,2.936,2.936,0,0,1-.057.526Z"
                fill="#f2a57f"
              />
              <path
                id="Path_929"
                data-name="Path 929"
                d="M34.06,41.356s.138-.315-.849-.388c0,0-1.108.2-.453,1.674a4.8,4.8,0,0,1,.332.995c.1.493-.081,1.165.186,1.618.34.566,1.213.243,1.262-.4a3.7,3.7,0,0,0-.7-1.7,1.326,1.326,0,0,1,.226-1.8Z"
                fill="#f2a57f"
              />
              <path
                id="Path_930"
                data-name="Path 930"
                d="M34.537,44.769a.461.461,0,0,1,.073.081.938.938,0,0,1,.146.275.873.873,0,0,1,.024.17.752.752,0,0,1,0,.243V45.8a1.892,1.892,0,0,1-.081.243,1.173,1.173,0,0,1-.113.226,1.78,1.78,0,0,1-.146.17.631.631,0,0,1-.3.218.9.9,0,0,1-.34.081,2.191,2.191,0,0,1,.17-.315,1.06,1.06,0,0,1,.081-.137.326.326,0,0,1,.073-.162,1.181,1.181,0,0,1,.081-.154.809.809,0,0,0,.065-.162,1.82,1.82,0,0,0,.121-.324,1.4,1.4,0,0,0,.04-.162v-.162A1.535,1.535,0,0,0,34.537,44.769Z"
                fill="#f2a57f"
              />
              <path
                id="Path_931"
                data-name="Path 931"
                d="M66.422,35.184q0,.639-.049,1.278a10.751,10.751,0,0,1-.073,1.529c-.121,2.346-.34,4.691-.655,6.94a7.148,7.148,0,0,1-.129.93v.105q-.089.631-.235,1.229V47.3a18.6,18.6,0,0,1-1.262,3.656h0a.339.339,0,0,1,0,.073,19.671,19.671,0,0,1-3.357,4.958h0a3.471,3.471,0,0,1-.275.307c-.372.4-.76.809-1.165,1.173A33.89,33.89,0,0,1,55.607,60.4h0c-.226.17-.453.324-.679.477A10.515,10.515,0,0,1,50.35,62.4a10.458,10.458,0,0,1-4.61-1.424c-.6-.34-1.181-.7-1.747-1.084a22.445,22.445,0,0,1-6.527-6.309,16.508,16.508,0,0,1-2.483-6.147c-.057-.291-.1-.59-.138-.89,0-.17-.049-.34-.065-.51-.065-.429-.113-.849-.17-1.286-.162-1.205-.332-2.427-.485-3.688h0l-.162-1.213h0a7.583,7.583,0,0,0-.1-.849c-.049-.437-.1-.865-.146-1.3a6.869,6.869,0,0,0-.089-.809h0v-.413a66.577,66.577,0,0,1-.332-9.116,35.241,35.241,0,0,1,1.06-7.951A18.077,18.077,0,0,1,39.487,15.7a21.3,21.3,0,0,1,3.559-1.367c.291-.089.6-.17.89-.243a35.476,35.476,0,0,1,8.638-.979,21.03,21.03,0,0,1,5.1.59h0a19.315,19.315,0,0,1,7.182,4.392,23.457,23.457,0,0,1,.809,3.171,42.8,42.8,0,0,1,.671,6.665C66.47,30.291,66.494,32.726,66.422,35.184Z"
                fill="#f4b78e"
              />
              <path
                id="Path_932"
                data-name="Path 932"
                d="M44.907,36.592a10.814,10.814,0,0,0-7.28-.55c1.262-3.818,7.821-1.262,7.821-1.262s.437.17.283.865C45.74,35.678,45.384,36.859,44.907,36.592Z"
                fill="#693d34"
              />
              <path
                id="Path_933"
                data-name="Path 933"
                d="M55.2,36.3a12.391,12.391,0,0,1,7.7-1.351c-1.618-3.68-8.412-.372-8.412-.372s-.413.21-.2.89C54.289,35.459,54.75,36.608,55.2,36.3Z"
                fill="#693d34"
              />
              <ellipse
                id="Ellipse_461"
                ...
                rx="1.432"
                ry="2.079"
                transform="translate(40.81 37.732) rotate(-0.34)"
                fill="#2f1806"
              />
              <circle
                id="Ellipse_462"
                ...
                cy="0.615"
                r="0.615"
                transform="translate(40.45 38.541)"
                fill="#fff"
              />
              <ellipse
                id="Ellipse_463"
                ...
                rx="2.079"
                ry="1.432"
                transform="translate(55.935 41.876) rotate(-89.66)"
                fill="#2f1806"
              />
              <circle
                id="Ellipse_464"
