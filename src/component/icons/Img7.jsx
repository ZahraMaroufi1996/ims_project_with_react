          ...
          <g id="Layer_1" data-name="Layer 1">
            ...
            >
              <rect
                ...
                width="36.171"
                height="39.77"
                transform="translate(29.975 36.762)"
                fill="#2f1806"
              />
              <rect
                id="Rectangle_787"
              ...
              <ellipse
                ...
                rx="1.432"
                ry="2.079"
                transform="translate(40.483 35.817) rotate(-0.34)"
                fill="#2f1806"
              />
              <circle
                id="Ellipse_474"
                ...
                cy="0.615"
                r="0.615"
                transform="translate(40.126 36.616)"
                fill="#fff"
              />
              <ellipse
                id="Ellipse_475"
                ...
                rx="2.079"
                ry="1.432"
                transform="translate(55.617 39.955) rotate(-89.66)"
                fill="#2f1806"
              />
              <circle
                id="Ellipse_476"
                ...
                cy="0.615"
                r="0.615"
                transform="translate(57.63 36.616)"
                fill="#fff"
              />
              <path
                id="Path_986"
                data-name="Path 986"
                d="M45.918,50.86c0,1.108,1.618,2.014,3.527,2.014s3.518-.9,3.527-2.014Z"
                fill="#fff"
              />
              <path
                id="Path_987"
                data-name="Path 987"
                d="M52.777,51.167a3.68,3.68,0,0,0,1.149-.429s-.574-.243-1.383-.485c-2.079-.874-1.933.259-3.041.259-.55,0-1.108-.582-1.618-.518a10.314,10.314,0,0,0-1.415.259,6.948,6.948,0,0,0-1.383.485,4.262,4.262,0,0,0,1.254.485,14.244,14.244,0,0,1,2.257.113,3.583,3.583,0,0,0,1.569,0,10.62,10.62,0,0,1,2.621-.21Z"
                fill="#f27d7f"
              />
              <path
                id="Path_988"
                data-name="Path 988"
                d="M53.238,50.738a5.4,5.4,0,0,1-4.044,1.618,5.168,5.168,0,0,1-3.429-1.618h-.7a.387.387,0,0,0,.073.17,7.214,7.214,0,0,0,.6,1.043l.4.534a5.663,5.663,0,0,0,.5.5l.267.251.315.21a2.685,2.685,0,0,0,.7.388,5.911,5.911,0,0,0,.809.259l.348.049h.17l.105.049H49.5l.809-.105a5.783,5.783,0,0,0,.809-.259,2.823,2.823,0,0,0,.679-.38l.315-.21.267-.251a5.548,5.548,0,0,0,.5-.5l.4-.534a7.053,7.053,0,0,0,.6-1.043c0-.057.049-.105.073-.162Z"
                fill="#f27d7f"
              />
              <path
                id="Path_989"
                data-name="Path 989"
                d="M49.444,53.383c2.888-.194,3.421-1.876,3.421-1.876a4.157,4.157,0,0,1-3.421,1.4.226.226,0,0,0-.186.251S49.29,53.383,49.444,53.383Z"
                fill="#fff"
              />
              <path
                id="Path_990"
                data-name="Path 990"
                d="M47.463,45.74h.073l.2-.049.639-.121c.243,0,.5-.073.76-.081s.51,0,.752,0l.728.049.364.04.356.049.34.057h.291l.21.04h.081V45.8a1.358,1.358,0,0,1-.065.2,1.885,1.885,0,0,1-.388.623,1.739,1.739,0,0,1-.356.315,2.071,2.071,0,0,1-.461.259,2.16,2.16,0,0,1-.542.162,2.337,2.337,0,0,1-.574.049,2.815,2.815,0,0,1-1.084-.251,2.564,2.564,0,0,1-.809-.558,2.257,2.257,0,0,1-.4-.59,1.262,1.262,0,0,1-.081-.2Z"
                fill="#f4a485"
              />
              <path
                id="Path_991"
                data-name="Path 991"
                d="M43.354,16.209l.291,5.646,1.415-.469Z"
                fill="#f4b78e"
              />
              <path
                id="Path_992"
                data-name="Path 992"
                d="M56.521,68.055l14.559,5.662s5.791,1.432,5.015,11.914H22.874c-.663-9.876,5.015-11.914,5.015-11.914l14.874-5.775,6.471,6.818Z"
                fill="#5858a6"
              />
              <path
                id="Path_993"
                data-name="Path 993"
                d="M49.25,74.753l-1.189-6.091-6.309-3.818-.914,3.842Z"
                fill="#6cb8c9"
              />
              <path
                id="Path_994"
                data-name="Path 994"
                d="M48.061,68.662l-2.985,5.46-7.288-4.95,3.963-4.327Z"
                fill="#bee4e5"
              />
              <path
                id="Path_995"
                data-name="Path 995"
                d="M49.25,74.753l1.189-6.091,6.309-3.818.922,3.842Z"
                fill="#6cb8c9"
              />
              <path
                id="Path_996"
                data-name="Path 996"
                d="M50.439,68.662l2.985,5.46,7.288-4.95-3.963-4.327Z"
                fill="#bee4e5"
              />
              <path
                id="Path_997"
                data-name="Path 997"
                d="M47.778,73.685l1.472,1.068,1.48-1.068V85.656H47.778Z"
                fill="#70bed0"
              />
              <circle
                id="Ellipse_477"
                ...
                cy="0.898"
                r="0.898"
                transform="translate(48.352 76.532)"
                fill="#bee4e5"
              />
              <circle
                id="Ellipse_478"
